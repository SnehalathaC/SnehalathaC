...
<body>
    <div class="items-center min-h-screen px-96 lg:justify-center py-14">
        <div class="flex item-center gap-4 pb-4 justify-center">
            <img alt="abrao_logo" data-src="https://abraogroup.com/wp-content/uploads/2020/09/logo.svg" class="main-logo ls-is-cached lazyloaded px-2" src="https://abraogroup.com/wp-content/uploads/2020/09/logo.svg" style="display: block;">
        </div>
        <div class="p-5 bg-white md:flex-1">
            ...
            <?php }?>
            <form action="login.php" class="flex flex-col space-y-5" method="post">
              <div class="flex flex-col space-y-1">
                <label for="email" class="text-sm font-semibold text-gray-500">Enter ID</label>
                <input
                  type="text"
                  id="username"
                  name = "username"
