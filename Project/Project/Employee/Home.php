...
<head>
    ...
    <title>Welcome to Abrao Group</title>
  ...
  <link rel="stylesheet" href="index-26874847.css">
</head>
<body><form action="../Logout.php">
  <header class="text-gray-600 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
      ...
      <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
        ...
        <a class="mr-5 hover:text-gray-900" href="../NewRequest/NewRequest.php">New Request</a>
      </nav>
  ...
  $sql = "SELECT * FROM `billrequest` WHERE Employee_ID='$id' ORDER BY S_NO desc";
    ...
    <table class="w-full bg-white border border-gray-200">
      ...
      <tbody >
        ...
        while($row=mysqli_fetch_assoc($result)){
          $i+=1;
          $rowID = $row["S_NO"];
          echo '<tr id="' . $rowID . '" style = "caret-color: transparent" class="cursor-pointer hover:bg-gray-50">';
