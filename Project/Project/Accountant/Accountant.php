...
<?php
  ...
  $sql = "SELECT * FROM `billrequest` WHERE Status='Approved' OR Status='Reimbursed' ORDER BY S_NO desc";
  ...
  <script>
    function openMail(mailId) {
      ...
      if (message) {
        ...
        window.location.href = 'Request_form.php?message=' + encodeURIComponent(message);
      } else {
